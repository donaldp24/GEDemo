...
public class ResolutionSet {
	...
	public static int _nWidth = 1280;
	public static int _nHeight = 720;
    public static final int designedWidth = 1280;
    public static final int designedHeight = 720;
	...
	{
		_nWidth = x; _nHeight = y;
        if (!isPortrate)
		    fXpro = (float)x / designedWidth;
        else
            fXpro = (float)x / designedHeight;
        if (!isPortrate)
		    fYpro = (float)y / designedHeight;
        else
            fYpro = (float)y / designedWidth;
